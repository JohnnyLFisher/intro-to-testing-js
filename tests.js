...
describe("sayHello", function () {
 ...
 describe("isVowel", function () {
	 ...
	 it('should return false when given 4', function () {
 ...
 describe("add", function (){
	 ...
	 it('should return 6 when given ("-4","10")', function () {
		 expect(add("-4","10")).toBe(6);
	 });
	 it('should return NaN when given ("banana","split")', function () {
		 expect(isNaN(add("banana","split"))).toBe(true);
	 });
	 it('should return NaN when given (2,"apples")', function () {
		 expect(isNaN(add(2,"apples"))).toBe(true);
	 });
	 it('should return NaN when called without any arguments', function () {
